...
export default function DisbursementScreen({ route }: { route: RouteProp<LoanStackParamList, 'Disbursement'> }) {
  ...
  const rows = [
    ...
    { label: 'Subsidy Proposed', value: formatInr(project.total_subsidy_amount_proposed) },
