...
def fresh_seed():
    ...
    BUCKETS = [
        # (count, stage_idx, bank_done, goc_done, work_done, completed, subsidy_released)
        (150,  5, False, False, False, False, False),  # bank_processing (30%)
        (100,  6, True,  False, False, False, False),  # goc_registration (20%)
        (100,  8, True,  True,  False, False, False),  # m2_structure_erection (20%)
        ( 75, 13, True,  True,  True,  False, False),  # m7_plantation (15%)
        ( 50, 17, True,  True,  True,  True,  False),  # subsidy_released (10%)
        ( 25, 18, True,  True,  True,  True,  True),   # completed (5%)
    ]
