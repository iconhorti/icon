import { useState, type FormEvent, type ComponentType, type CSSProperties } from 'react';
import { useNavigate } from 'react-router-dom';
import { login } from '../api/client';
import { useAuth } from '../context/AuthContext';
import {
  ShieldCheck, Users, Tractor, FileText, Landmark,
  Sprout, Hammer, ClipboardList, Eye, EyeOff, type LucideProps,
} from 'lucide-react';
import './Login.css';
...
const Login = () => {
  ...
  const doLogin = async (u: string, p: string, roleLabel: string | null = null): Promise<void> => {
  ...
  const handleRoleTile = (tile: DemoRole) => {
