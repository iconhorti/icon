...
const getAllowedTypes = (role) => ROLE_UPLOAD_TYPES[role] ?? [];
...
// ── Upload Modal ──────────────────────────────────────────────────────────────
const UploadModal = ({ onClose, onSuccess, allowedTypes }) => {
...
// ── Document Card ─────────────────────────────────────────────────────────────
const DocCard = ({ doc, onVerify, onDelete, canVerify, canDelete }) => {
...
const Documents = () => {
  ...
  const handleVerify = async (docId, revoke = false) => {
    try {
      if (revoke) {
