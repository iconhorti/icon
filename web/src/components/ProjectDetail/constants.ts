...
export const CAN_ADVANCE: Record<string, boolean> = {
  admin:                 true,
  owner:                 true,
...
export const CAN_REVERT: Record<string, boolean> = {
  admin:                 true,
  owner:                 true,
  office_staff:          true,
...
export const STAGE_REQUIRED_FIELDS: Record<string, RequiredField[]> = {
  bank_processing:   [
